...
ADMIN_ID = os.environ.get("ADMIN_ID") # Render Env me apni ID dalein
...
async def update_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    if not await is_owner(update):
        return # Sirf owner ke liye, users ko reply bhi nahi dega
...
async def handle_json_file(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    status_msg = await update.message.reply_text("⏳ Updating GitHub... Render will auto-restart soon.")
    ...
    try:
        ...
        await status_msg.edit_text("✅ Success! GitHub Updated. Render is deploying now...")
